...
class VisitedVertex {
    ...
    public VisitedVertex(int length, int index) {
        ...
        this.dis[index] = 0; // 设置触发顶点的访问距离为0
    }

    // 判断index顶点是否被访问过
    // 如果访问过就返回true，否则放回false
...
class Graph {
    ...
    private VisitedVertex vv; // 已访问的点
    ...
    public void dsj(int index) {
        ...
        update(index); // 更新 index 下标顶点到周围顶点的距离和前驱顶点
